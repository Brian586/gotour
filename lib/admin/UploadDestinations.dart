...
class UploadDestinations extends StatefulWidget {
  ...
  const UploadDestinations({Key key}) : super(key: key);

  @override
  _UploadDestinationsState createState() => _UploadDestinationsState();
}

class _UploadDestinationsState extends State<UploadDestinations>
    with AutomaticKeepAliveClientMixin<UploadDestinations> {
  File file;
  ...
  savePostInfoToFireStore({
    ...
    destinationsReference.doc(postId).set({
      "postId": postId,
  ...
  //   StorageUploadTask mStorageUploadTask = storageReference.child().putFile(mImageFile);
                            ...
                            Row(
                              children: [
                                Expanded(
                                  child: CustomField(
                                      controller:
                                          _localityTextEditingController,
                                      hintText: "Locality",
                                      width: width,
                                      isDigits: false,
                                      widget: null),
                                ...
                                FloatingActionButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    _localityTextEditingController
                                            .text.isNotEmpty
                                        ? localityList.add(
                                            _localityTextEditingController.text
                                                .trim())
                                        : Fluttertoast.showToast(
                                            msg: "Field is empty");
                            ...
                            uploading
                                ...
                                : ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      String locality = localityList[index];
